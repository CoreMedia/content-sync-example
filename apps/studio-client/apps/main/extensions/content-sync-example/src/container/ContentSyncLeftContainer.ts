...
class ContentSyncLeftContainer extends ContentSyncLeftContainerBase{
  ...
  items:[
    Config(CollapsiblePanel, {
      ...
      items:[
        Config(BoundRadioGroup, {
          ...
          bindTo: new ConfigBasedValueExpression({ context: config.modelBean, expression: "selectedSyncMode"
          }),
          items:[
            Config(Radio, { itemId:  ContentSyncEditorBase.PARTIAL_SYNC_ID,
    ...
    Config(CollapsiblePanel, {
            ...
            collapsed: false,
      items:[
        Config(SettingsAwareRadioGroup, { vertical: false, columns: 1, modelBean: config.modelBean})
      ]
    }),
    Config(CollapsiblePanel, {
            ...
            collapsed: false,
      items:[
        Config(Button, { ui: ConfigUtils.asString( ButtonSkin.MATERIAL_SECONDARY), text:  ContentSyncPluginResources_properties.ContentSync_WFS_StartButton_Label,
    ...
    Config(CollapsiblePanel, {
            ...
            collapsed: false,
      items:[
        Config(ExcludeListRadioGroup, { modelBean: config.modelBean, modelProperty:  ExcludeListRadioGroupBase.PROPERTY_EXCLUDE})
      ],
      layout: Config(HBoxLayout),
      plugins:[
        Config(BindVisibilityPlugin, { bindTo: this.getExcludePropertiesVE(), transformer: bind(this,this.hasEntries)})
      ]
    }),
    Config(CollapsiblePanel, {
            ...
            collapsed: false,
      items:[
        Config(ExcludeListRadioGroup, { modelBean: config.modelBean, modelProperty:  ExcludeListRadioGroupBase.CONTENT_TYPE_EXCLUDE})
      ],
      layout: Config(HBoxLayout),
      plugins:[
        Config(BindVisibilityPlugin, { bindTo: this.getExcludeContentTypeVE(), transformer: bind(this,this.hasEntries)})
      ]
    }),
