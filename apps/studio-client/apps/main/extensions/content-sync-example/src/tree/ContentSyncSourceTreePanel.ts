...
class ContentSyncSourceTreePanel extends ContentSyncSourceTreePanelBase {
  ...
  static override readonly xtype: string = "com.coremedia.blueprint.contentsync.studio.tree.contentSyncSourceTreePanel";
      ...
      tbar: Config(Toolbar, {
        ...
        items: [
          Config(IconButton, {
            ...
            baseAction: new ReloadSourcePanelAction({ modelBean: config.modelBean }),
          }),
        ],
      }),
      columns: [
