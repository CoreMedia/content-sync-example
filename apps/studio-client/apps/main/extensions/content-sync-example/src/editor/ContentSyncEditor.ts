  ...
  constructor(config: Config<ContentSyncEditor> = null) {
     ...
     */
        ...
        Config(SwitchingContainer, {
          ...
          scrollable: true,
          items: [
            Config(PartialSyncPanel, {
              itemId: ContentSyncEditorBase.PARTIAL_SYNC_PANEL_ID,
              modelBean: this$.getModel(config),
            }),
         ...
         */
          ...
          activeItemValueExpression: new ConfigBasedValueExpression({
            context: this$.getModel(config),
            expression: ContentSyncConstants.SWITCHING_CONTAINER_CONTROL_ID,
          }),
        }),
      ],
