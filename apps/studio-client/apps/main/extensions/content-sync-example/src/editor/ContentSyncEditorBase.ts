...
class ContentSyncEditorBase extends Panel {
  ...
  get defaulSyncMode():string { return this.#defaulSyncMode; }
  set defaulSyncMode(value:string) { this.#defaulSyncMode = value; }
  ...
  #handleModelUpdate(){
    var bean = this.getModel(this.getInitialConfig());
